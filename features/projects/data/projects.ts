...
export const Projects: projectList = {
    ...
    meijelgezondai: {
        ...
        description: "Een custom applicatie waarmee de eigenaar AI-chatbots kan aanmaken en beheren. Per chatbot kan een naam en system prompt worden ingesteld, waarna er uit verschillende AI-modellen gekozen kunnen worden die via een externe API beschikbaar worden gesteld. De applicatie biedt een flexibele basis voor het configureren en testen van gepersonaliseerde AI-chatbots.",
