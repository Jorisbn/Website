                    ...
                    <div className="text-center">
                        <div className="mb-8">
                            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
                                Hi, Ik ben <span className="bg-linear-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Joris</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row justify-start sm:justify-center gap-4 mb-12">
                                <a
                                    href="#projects"
                                    className="px-8 py-4 bg-linear-to-r from-cyan-500 to-purple-500 text-white rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-600 transition-all transform hover:scale-105"
                                >
                            ...
                            <div className="flex justify-center gap-6">
                                <a
                                    href="https://github.com/Jorisbn"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-gray-400 hover:text-gray-300 transition-colors"
                                    aria-label="Mijn Github"
                                >
                                    <svg
